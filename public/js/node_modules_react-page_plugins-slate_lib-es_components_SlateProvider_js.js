(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_react-page_plugins-slate_lib-es_components_SlateProvider_js"],{
...
/***/ "./node_modules/@react-page/plugins-slate/lib-es/components/SlateProvider.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/components/SlateProvider.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _react_page_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @react-page/editor */ "./node_modules/@react-page/editor/lib-es/core/utils/deepEquals.js");
...
/* harmony import */ var _slateEnhancer_withInline__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../slateEnhancer/withInline */ "./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withInline.js");
/* harmony import */ var _slateEnhancer_withPaste__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../slateEnhancer/withPaste */ "./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withPaste.js");
...
var SlateProvider = function (props) {
    ...
    var _a = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(data === null || data === void 0 ? void 0 : data.slate), 2), value = _a[0], setValue = _a[1];
    ...
    var editor = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
        return (0,_slateEnhancer_withPaste__WEBPACK_IMPORTED_MODULE_2__["default"])(plugins, defaultPluginType)((0,slate_react__WEBPACK_IMPORTED_MODULE_3__.withReact)((0,_slateEnhancer_withInline__WEBPACK_IMPORTED_MODULE_4__["default"])(plugins)((0,slate__WEBPACK_IMPORTED_MODULE_5__.createEditor)())));
    }, []);
    var onChangeDebounced = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
        props.onChange({
            ...
            notUndoable: (0,_react_page_editor__WEBPACK_IMPORTED_MODULE_6__["default"])(valueRef.current, data.slate),
        });
    }, 200), [props.onChange, editor, data.slate]);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        if (data.selection) {
            // update seleciton, if changed from outside (e.g. through undo)
            slate__WEBPACK_IMPORTED_MODULE_5__.Transforms.select(editor, data.selection);
        }
        else {
    ...
    var onChange = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (v) {
        if (editor.selection) {
            setValue(v);
            onChangeDebounced();
        }
    }, [onChangeDebounced]);
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(_DialogVisibleProvider__WEBPACK_IMPORTED_MODULE_7__["default"], null,
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(slate_react__WEBPACK_IMPORTED_MODULE_3__.Slate, { editor: editor, value: value, onChange: onChange }, children)));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SlateProvider);
//# sourceMappingURL=SlateProvider.js.map

/***/ }),

/***/ "./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withInline.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withInline.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (withInline);
//# sourceMappingURL=withInline.js.map

/***/ }),

/***/ "./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withPaste.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/slateEnhancer/withPaste.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _htmlToSlate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../htmlToSlate */ "./node_modules/@react-page/plugins-slate/lib-es/htmlToSlate/index.js");
...
var withPaste = function (plugins, defaultPluginType) { return function (editor) {
    ...
    var htmlToSlate = (0,_htmlToSlate__WEBPACK_IMPORTED_MODULE_0__.HtmlToSlate)({ plugins: plugins });
    editor.insertData = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var slateData, html, slate, text, lines, nextWillbeParagraph, i, thisLine, nextLine, nextIsEmpty, thisLineText;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (withPaste);
