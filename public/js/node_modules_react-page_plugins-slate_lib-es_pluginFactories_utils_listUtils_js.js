(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_react-page_plugins-slate_lib-es_pluginFactories_utils_listUtils_js"],{

/***/ "./node_modules/@react-page/plugins-slate/lib-es/pluginFactories/utils/listUtils.js":
/*!******************************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/pluginFactories/utils/listUtils.js ***!
  \******************************************************************************************/
...
/* harmony export */   "getActiveListType": () => (/* binding */ getActiveListType),
/* harmony export */   "getPreviousListItem": () => (/* binding */ getPreviousListItem),
/* harmony export */   "increaseListIndention": () => (/* binding */ increaseListIndention),
/* harmony export */   "decreaseListIndention": () => (/* binding */ decreaseListIndention)
/* harmony export */ });
...
var moveToParent = function (editor, nodePath, targetPath, parentIsList) {
    ...
    if (!parentIsList) {
        ...
        var onlyTextChildren = (_a = (targetNode === null || targetNode === void 0 ? void 0 : targetNode[0])
            .children) === null || _a === void 0 ? void 0 : _a.every(function (child) { return slate__WEBPACK_IMPORTED_MODULE_0__.Text.isText(child) || slate__WEBPACK_IMPORTED_MODULE_0__.Editor.isInline(editor, child); });
        if (onlyTextChildren) {
            slate__WEBPACK_IMPORTED_MODULE_0__.Transforms.setNodes(editor, {
                type: null,
            }, {
...
var decreaseListIndention = function (editor, def) {
    ...
    if (isFirstInItsList) {
        ...
        if (parentIsList) {
            var previousParagraphPath = __spread(slate__WEBPACK_IMPORTED_MODULE_0__.Path.previous(targetPath), [0]);
