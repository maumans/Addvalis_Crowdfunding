(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_react-page_plugins-slate_lib-es_components_SlateEditor_js"],{
...
/***/ "./node_modules/@react-page/plugins-slate/lib-es/components/SlateEditor.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/components/SlateEditor.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _react_page_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @react-page/editor */ "./node_modules/@react-page/editor/lib-es/core/components/hooks/options.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
...
/* harmony import */ var _DialogVisibleProvider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DialogVisibleProvider */ "./node_modules/@react-page/plugins-slate/lib-es/components/DialogVisibleProvider.js");
/* harmony import */ var _hotkeyHooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./hotkeyHooks */ "./node_modules/@react-page/plugins-slate/lib-es/components/hotkeyHooks.js");
/* harmony import */ var _renderHooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderHooks */ "./node_modules/@react-page/plugins-slate/lib-es/components/renderHooks.js");
...
var HoverButtons = (0,_react_page_editor__WEBPACK_IMPORTED_MODULE_1__["default"])(function () { return __webpack_require__.e(/*! import() */ "node_modules_react-page_plugins-slate_lib-es_components_HoverButtons_js").then(__webpack_require__.bind(__webpack_require__, /*! ./HoverButtons */ "./node_modules/@react-page/plugins-slate/lib-es/components/HoverButtons.js")); });
var SlateEditable = react__WEBPACK_IMPORTED_MODULE_0__.memo(function (props) {
    ...
    var renderElement = (0,_renderHooks__WEBPACK_IMPORTED_MODULE_3__.useRenderElement)({ plugins: plugins, defaultPluginType: defaultPluginType, injections: injections }, []);
    var renderLeaf = (0,_renderHooks__WEBPACK_IMPORTED_MODULE_3__.useRenderLeave)({ plugins: plugins, injections: injections }, []);
    var onKeyDown = (0,_hotkeyHooks__WEBPACK_IMPORTED_MODULE_4__.useOnKeyDown)({ plugins: plugins }, []);
    // this is required so that dialogs & controls don't mess with slate's selection
    var dialogVisible = (0,_DialogVisibleProvider__WEBPACK_IMPORTED_MODULE_5__.useDialogIsVisible)();
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(slate_react__WEBPACK_IMPORTED_MODULE_2__.Editable, { placeholder: readOnly ? undefined : placeholder, readOnly: dialogVisible || readOnly, renderElement: renderElement, renderLeaf: renderLeaf, onKeyDown: readOnly ? undefined : onKeyDown }));
});
var SlateEditor = function (props) {
    var plugins = props.plugins, focused = props.focused, readOnly = props.readOnly;
    var t = (0,_react_page_editor__WEBPACK_IMPORTED_MODULE_6__.useUiTranslator)().t;
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        !readOnly && focused && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(HoverButtons, { plugins: props.plugins, translations: props.translations })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(SlateEditable, { placeholder: t(props.translations.placeholder), readOnly: readOnly, plugins: plugins, defaultPluginType: props.defaultPluginType })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (react__WEBPACK_IMPORTED_MODULE_0__.memo(SlateEditor));
//# sourceMappingURL=SlateEditor.js.map

/***/ }),

/***/ "./node_modules/@react-page/plugins-slate/lib-es/components/hotkeyHooks.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@react-page/plugins-slate/lib-es/components/hotkeyHooks.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useOnKeyDown": () => (/* binding */ useOnKeyDown)
/* harmony export */ });
...
/* harmony import */ var slate_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! slate-react */ "./node_modules/slate-react/dist/index.es.js");
/* harmony import */ var _hooks_useAddPlugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../hooks/useAddPlugin */ "./node_modules/@react-page/plugins-slate/lib-es/hooks/useAddPlugin.js");
/* harmony import */ var _hooks_useCurrentNodeWithPlugin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../hooks/useCurrentNodeWithPlugin */ "./node_modules/@react-page/plugins-slate/lib-es/hooks/useCurrentNodeWithPlugin.js");
/* harmony import */ var _hooks_useRemovePlugin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../hooks/useRemovePlugin */ "./node_modules/@react-page/plugins-slate/lib-es/hooks/useRemovePlugin.js");
...
var useOnKeyDown = function (_a, deps) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1__.useCallback(function (event) {
        plugins
            .filter(function (plugin) { return plugin.hotKey; })
            .forEach(function (plugin) {
            if ((0,is_hotkey__WEBPACK_IMPORTED_MODULE_0__["default"])(plugin.hotKey, event)) {
                event.preventDefault();
                var node = (0,_hooks_useCurrentNodeWithPlugin__WEBPACK_IMPORTED_MODULE_3__.getCurrentNodeWithPlugin)(editor, plugin);
                if (node) {
                    (0,_hooks_useRemovePlugin__WEBPACK_IMPORTED_MODULE_4__.removePlugin)(editor, plugin);
                }
                else {
                    (0,_hooks_useAddPlugin__WEBPACK_IMPORTED_MODULE_5__.addPlugin)(editor, plugin);
                }
            }
        });
        // we need to prevent slate from handling undo and redo
        if ((0,is_hotkey__WEBPACK_IMPORTED_MODULE_0__["default"])(['mod+z', 'mod+y'], event)) {
            event.preventDefault();
            return true;
        }
        if ((0,is_hotkey__WEBPACK_IMPORTED_MODULE_0__["default"])('shift+enter', event)) {
            event.preventDefault();
            editor.insertText('\n');
            return true;
        }
