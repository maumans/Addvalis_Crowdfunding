        ...
        >
           ...
           <div className={"mb-64"}>
              <div className="ml-10 md:justify-start">
               ...
               <div className={"projetfont grid md:grid-cols-4 sm:grid-cols-3  grid-cols-1 gap-10 mx-10 mb-10"}>
                       {
                           projets.map((p)=>(
                                   <div key={p.id} className={"bg-black overflow-hidden"} style={{maxHeight:400}}>
                                       ...
                                       <Link href={route("user.projet.show",[auth.user.id,p.id])}>
                                           <div className={"text-center relative h-full"}>
                                               ...
                                               <img src={p.image} style={{objectFit:"cover"}} className={"h-full w-full transform hover:scale-110 transition duration-500"}/>
                                               <div className={"absolute bottom-0 w-full bg-gradient-to-t from-black pb-5"}>
                                                   <div className={"bg-transparent"}>
                                                       ...
                                                       <p className={"text-sm sm:text-sm md:text-lg text-white mt-5"} data-aos-once={true} data-aos="flip-up" data-aos-delay="500" data-aos-duration="1000">{p.description}</p>
                                                   </div>
                                               </div>
                                           </div>
                                       </Link>
