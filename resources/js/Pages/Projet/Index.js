...
export default function Index(props) {
    ...
    function TinyEditorComponent(props) {
        ...
        return (
            <Editor
                initialValue="<p>Parlez nous de votre projet en detail</p>"
                init={{
                    height: 200,
                    plugins: [
    ...
    function infosProjet()
    {
        return <div className={"ml-2 flex flex-col"}>
                ...
                <TextField label="Montant initial" variant="standard" />
                <TextField label="Montant à financer" variant="standard" />
